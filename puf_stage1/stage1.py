...
return_growth_rate = pd.concat([return_growth_rate, ret_growth_vals], ignore_index=False)
...
for i in range(SOI_YR, EYR):  # SOI Estimates loop
    ...
    return_projection = pd.concat([return_projection, current_year], ignore_index=False)
